"""Regression checks for the watch-parse-markdown-scope casebook."""
...
from casebook.harness import assert_expected, watch_parse_markdown_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_parse_markdown_scope_summary(), assert_expected())
